...
// INFO: This is SAMPLE data that needs to be developped AND refined according to official TT content.
...
teamAttention[TEAM_ATTENTIONS.ComplicatedSubsystem] =
  'Complicated Sub-system teams are for very specific situations. Carefuly cross-check if your context does not suit other team types before applying a Complicated Sub-system.'
