import { TEAM_ENUM, TeamElementInterface } from './team-static';
...
export class TeamFactory {
  private static TeamElements: TeamElementInterface[];
  ...
  getTeamElements(): TeamElementInterface[] {
    return TeamFactory.TeamElements;
  }

  // Return a specific instance matching the TEAM_ELEMENTS
  getTeamElement(teamEnum: TEAM_ENUM): TeamElementInterface {
    return (
  ...
  getTeamElementFromClassList(classList: DOMTokenList): TeamElementInterface {
